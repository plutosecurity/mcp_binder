...
MCP Binder has four operator-facing flows. Start with deployment, then keep the other pages nearby while running a lab.
...
| [Architecture](architecture.md) | Components, data flow, trust boundaries, and compatibility notes. |
| [Threat Model](threat-model.md) | Protected assets, assumptions, risks, and explicit non-goals. |
